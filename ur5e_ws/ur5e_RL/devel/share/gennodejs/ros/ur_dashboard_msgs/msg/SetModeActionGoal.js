...
class SetModeActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = SetModeGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new SetModeActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = SetModeGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new SetModeGoal()
    }
...
module.exports = SetModeActionGoal;
