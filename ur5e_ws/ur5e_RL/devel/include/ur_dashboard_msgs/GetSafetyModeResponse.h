...
bool operator==(const ::ur_dashboard_msgs::GetSafetyModeResponse_<ContainerAllocator1> & lhs, const ::ur_dashboard_msgs::GetSafetyModeResponse_<ContainerAllocator2> & rhs)
{
