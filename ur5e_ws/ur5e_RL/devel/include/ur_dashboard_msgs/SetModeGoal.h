...
struct SetModeGoal_
{
  ...
  (void)_alloc;
   ...
   typedef  ::ur_dashboard_msgs::RobotMode_<ContainerAllocator>  _target_robot_mode_type;
...
bool operator==(const ::ur_dashboard_msgs::SetModeGoal_<ContainerAllocator1> & lhs, const ::ur_dashboard_msgs::SetModeGoal_<ContainerAllocator2> & rhs)
{
  return lhs.target_robot_mode == rhs.target_robot_mode &&
    lhs.stop_program == rhs.stop_program &&
    lhs.play_program == rhs.play_program;
}
...
struct MD5Sum< ::ur_dashboard_msgs::SetModeGoal_<ContainerAllocator> >
{
  ...
  static const uint64_t static_value1 = 0xa32b63f0e8a660b2ULL;
  static const uint64_t static_value2 = 0xb96916617d699c39ULL;
};
...
struct Printer< ::ur_dashboard_msgs::SetModeGoal_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ur_dashboard_msgs::SetModeGoal_<ContainerAllocator>& v)
  {
    ...
    s << std::endl;
    Printer< ::ur_dashboard_msgs::RobotMode_<ContainerAllocator> >::stream(s, indent + "  ", v.target_robot_mode);
