...
bool operator==(const ::ur_dashboard_msgs::SetModeActionResult_<ContainerAllocator1> & lhs, const ::ur_dashboard_msgs::SetModeActionResult_<ContainerAllocator2> & rhs)
{
