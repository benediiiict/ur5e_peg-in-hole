...
struct IsProgramSavedResponse_
{
  ...
  _answer_type answer;
   ...
   typedef std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>> _program_name_type;
...
bool operator==(const ::ur_dashboard_msgs::IsProgramSavedResponse_<ContainerAllocator1> & lhs, const ::ur_dashboard_msgs::IsProgramSavedResponse_<ContainerAllocator2> & rhs)
{
  return lhs.answer == rhs.answer &&
    lhs.program_name == rhs.program_name &&
    lhs.program_saved == rhs.program_saved &&
...
struct Printer< ::ur_dashboard_msgs::IsProgramSavedResponse_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ur_dashboard_msgs::IsProgramSavedResponse_<ContainerAllocator>& v)
  {
    ...
    Printer<std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>>::stream(s, indent + "  ", v.program_name);
