...
bool operator==(const ::ur_dashboard_msgs::GetProgramStateResponse_<ContainerAllocator1> & lhs, const ::ur_dashboard_msgs::GetProgramStateResponse_<ContainerAllocator2> & rhs)
{
