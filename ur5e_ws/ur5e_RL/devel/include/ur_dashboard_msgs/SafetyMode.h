...
#endif
#if defined(_WIN32) && defined(RECOVERY)
  #undef RECOVERY
#endif
#if defined(_WIN32) && defined(SAFEGUARD_STOP)
  #undef SAFEGUARD_STOP
#endif
#if defined(_WIN32) && defined(SYSTEM_EMERGENCY_STOP)
  #undef SYSTEM_EMERGENCY_STOP
#endif
#if defined(_WIN32) && defined(ROBOT_EMERGENCY_STOP)
  #undef ROBOT_EMERGENCY_STOP
#endif
#if defined(_WIN32) && defined(VIOLATION)
  #undef VIOLATION
#endif
#if defined(_WIN32) && defined(FAULT)
  #undef FAULT
#endif
#if defined(_WIN32) && defined(VALIDATE_JOINT_ID)
  #undef VALIDATE_JOINT_ID
#endif
#if defined(_WIN32) && defined(UNDEFINED_SAFETY_MODE)
  #undef UNDEFINED_SAFETY_MODE
#endif
#if defined(_WIN32) && defined(AUTOMATIC_MODE_SAFEGUARD_STOP)
  #undef AUTOMATIC_MODE_SAFEGUARD_STOP
#endif
#if defined(_WIN32) && defined(SYSTEM_THREE_POSITION_ENABLING_STOP)
  #undef SYSTEM_THREE_POSITION_ENABLING_STOP
#endif
...
bool operator==(const ::ur_dashboard_msgs::SafetyMode_<ContainerAllocator1> & lhs, const ::ur_dashboard_msgs::SafetyMode_<ContainerAllocator2> & rhs)
{
