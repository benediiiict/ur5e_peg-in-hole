...
class SetModeAction(genpy.Message):
  _md5sum = "7048f11efd68ac8c7a2750e444f501df"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_b2B3I().pack(_x.action_goal.goal.target_robot_mode.mode, _x.action_goal.goal.stop_program, _x.action_goal.goal.play_program, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.action_goal.goal.target_robot_mode.mode, _x.action_goal.goal.stop_program, _x.action_goal.goal.play_program, _x.action_result.header.seq, _x.action_result.header.stamp.secs, _x.action_result.header.stamp.nsecs,) = _get_struct_b2B3I().unpack(str[start:end])
