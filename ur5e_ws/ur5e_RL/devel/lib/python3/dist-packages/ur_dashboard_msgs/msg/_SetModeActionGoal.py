...
class SetModeActionGoal(genpy.Message):
  _md5sum = "0012d5645be9adc78c7732326d965640"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_b2B().pack(_x.goal.target_robot_mode.mode, _x.goal.stop_program, _x.goal.play_program))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.goal.target_robot_mode.mode, _x.goal.stop_program, _x.goal.play_program,) = _get_struct_b2B().unpack(str[start:end])
