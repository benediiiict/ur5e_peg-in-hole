...
echo_and_run cd "/home/ben/work/ur5e_RL/src/robotiq_gripper/robotiq_modbus_rtu"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ben/work/ur5e_RL/src/robotiq_gripper/robotiq_modbus_rtu/setup.py" \
     \
    build --build-base "/home/ben/work/ur5e_RL/build/robotiq_gripper/robotiq_modbus_rtu" \
    install \
    --root="${DESTDIR-/}" \
