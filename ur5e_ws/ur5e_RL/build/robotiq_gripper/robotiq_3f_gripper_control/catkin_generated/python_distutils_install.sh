...
echo_and_run cd "/home/ben/work/ur5e_RL/src/robotiq_gripper/robotiq_3f_gripper_control"
...
echo_and_run /usr/bin/env \
    ...
    "/home/ben/work/ur5e_RL/src/robotiq_gripper/robotiq_3f_gripper_control/setup.py" \
     \
    build --build-base "/home/ben/work/ur5e_RL/build/robotiq_gripper/robotiq_3f_gripper_control" \
    install \
    --root="${DESTDIR-/}" \
